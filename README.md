...
Published release: [1.2.1](https://github.com/XF1-Advisory-Services/xf1-mcp/releases/tag/v1.2.1). Public MCP endpoint: `https://xf1-mcp.vercel.app/api/mcp`. See [colleague setup](distribution/README.md).
